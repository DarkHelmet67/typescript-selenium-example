...
import { bsPassword, bsUserName, getBrowserStackCapabilities, getLocalCapabilities } from '../bs-config';
...
getBrowserStackCapabilities('browserstack-build-1', 'Lesson 1: Automation Introduction and Basic Scripting').forEach((capabilities: {} | Capabilities) => {
